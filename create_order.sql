...
`order_type_id`  int(11) NOT NULL DEFAULT 0 COMMENT '销售、换货' ,
`member_id`  int(11) NOT NULL DEFAULT 0 COMMENT '会员ID' ,
`consignee_id`  int(11) NOT NULL DEFAULT 0 COMMENT '收货人ID' ,
...
`payment_type_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '支付方式ID' ,
`payment_type_name`  varchar(20) NOT NULL DEFAULT '' COMMENT '支付方式名称' ,
`payment_status`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '支付状态' ,
`source_ref_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '订单广告来源ID' ,
`source_pos_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '订单站内位置ID' ,
...
`quality`  smallint(6) NOT NULL DEFAULT 0 COMMENT '购买数量' ,
`return_quality`  smallint(6) NOT NULL DEFAULT 0 COMMENT '退货数量' ,
`create_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '记录生成人' ,
`create_date`  datetime NOT NULL COMMENT '记录生成时间' ,
`update_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '更新人' ,
`update_date`  datetime NOT NULL COMMENT '更新时间' ,
...
`deliver_type_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '配送方式ID' ,
...
`payment_type_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '支付方式ID' ,
`payment_type_name`  varchar(20) NOT NULL DEFAULT '' COMMENT '支付方式名称' ,
`quality`  smallint(6) NOT NULL DEFAULT 0 COMMENT '商品数量' ,
...
`form_code`  varchar(15) NOT NULL COMMENT '订单号' ,
`return_type_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '退换货类型ID' ,
`consignee_id`  int(11) NOT NULL DEFAULT 0 COMMENT '收货人ID' ,
...
`reason_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '退货原因ID' ,
...
`id`  int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增主键' ,
`accept_code`  varchar(15) NOT NULL COMMENT '受理单号' ,
`direction`  int(11) NOT NULL DEFAULT 0 COMMENT '方向：0取回，1换出' ,
`order_detail_id`  int(11) UNSIGNED NOT NULL COMMENT '原订单字表明细行ID' ,
`commodity_no`  varchar(15) NOT NULL COMMENT '商品编号' ,
`commodity_name`  varchar(200) NOT NULL DEFAULT '' COMMENT '商品名称' ,
`product_no`  varchar(15) NOT NULL COMMENT '货品编号' ,
`size`  varchar(30) NOT NULL DEFAULT '' COMMENT '尺码' ,
`sell_price`  decimal(18,2) NOT NULL DEFAULT 0 COMMENT '货品卖价' ,
`discount`  decimal(18,2) NOT NULL DEFAULT 0 COMMENT '折扣' ,
`quality`  smallint(6) NOT NULL DEFAULT 0 COMMENT '数量' ,
`ref_id`  int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '对于换，要关联到退的ID' ,
`create_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '记录生成人' ,
`create_date`  datetime NOT NULL COMMENT '记录生成时间' ,
`update_person`  varchar(30) NOT NULL DEFAULT '' COMMENT '更新人' ,
`update_date`  datetime NOT NULL COMMENT '更新时间' ,
...
`return_code`  varchar(15) NOT NULL COMMENT '退换货入库单号' ,
`member_id`  int(11) NOT NULL DEFAULT 0 COMMENT '会员ID' ,
`refund_type_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '退款单类型ID' ,
`payment_type_id`  tinyint(4) NOT NULL DEFAULT 0 COMMENT '退款方式ID' ,
